...
const ApiKeyRecordsSchema = z.array(ApiKeyRecordSchema).refine((records) => new Set(records.map(r => r.keyId)).size === records.length, { message: "Duplicate keyId values in RELAY_API_KEYS_JSON" });
